...
@inject('context')
@observer
export class TransitionJoinWidget extends React.Component<StateJoinNodeWidgetProps> {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <PortWidget name="join1" node={this.props.node} />
        </div>
        <div
          style={{
            position: 'absolute',
        ...
        >
          <PortWidget name="join2" node={this.props.node} />
        </div>
        <div
          style={{
            position: 'absolute',
        ...
        >
          <PortWidget name="join3" node={this.props.node} />
        </div>
        <div
          style={{
            position: 'absolute',
        ...
        >
          <PortWidget name="yield" node={this.props.node} />
        </div>
      </div>
    );
  }
...
export let TransitionJoinWidgetFactory = React.createFactory(TransitionJoinWidget);
